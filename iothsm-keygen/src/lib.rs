...
//! This library is used to create and load keys for the Azure IoT Edge daemon.
//!
...
//! readers looking to understand this particular implementation, as well as readers looking to implement their own keygen library.
//!
//!
//! # API conventions
//!
...
/// Represents the version of the keygen API exported by this library.
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
#[repr(transparent)]
...
pub struct KEYGEN_FUNCTION_LIST {
	/// The version of the keygen API represented in this function list.
	///
...
/// Get the list of functions for keygen operations corresponding to the specified version.
///
/// Implementations can use this function for initialization, since it is guaranteed to be called before any keygen operations.
...
/// RSA PKCS1
pub const KEYGEN_SIGN_MECHANISM_RSA_PKCS1: KEYGEN_SIGN_MECHANISM = KEYGEN_SIGN_MECHANISM { inner: 2 };

/// RSA-PSS
pub const KEYGEN_SIGN_MECHANISM_RSA_PSS: KEYGEN_SIGN_MECHANISM = KEYGEN_SIGN_MECHANISM { inner: 3 };

/// HMAC-SHA256
pub const KEYGEN_SIGN_MECHANISM_HMAC_SHA256: KEYGEN_SIGN_MECHANISM = KEYGEN_SIGN_MECHANISM { inner: 4 };
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
#[repr(transparent)]
pub struct KEYGEN_RSA_PKCS1_MESSAGE_DIGEST { inner: std::os::raw::c_uint }

/// SHA-1
pub const KEYGEN_RSA_PKCS1_MESSAGE_DIGEST_SHA1: KEYGEN_RSA_PKCS1_MESSAGE_DIGEST =
	KEYGEN_RSA_PKCS1_MESSAGE_DIGEST { inner: 2 };

/// SHA-224
pub const KEYGEN_RSA_PKCS1_MESSAGE_DIGEST_SHA224: KEYGEN_RSA_PKCS1_MESSAGE_DIGEST =
	KEYGEN_RSA_PKCS1_MESSAGE_DIGEST { inner: 3 };

/// SHA-256
pub const KEYGEN_RSA_PKCS1_MESSAGE_DIGEST_SHA256: KEYGEN_RSA_PKCS1_MESSAGE_DIGEST =
	KEYGEN_RSA_PKCS1_MESSAGE_DIGEST { inner: 4 };

/// SHA-384
pub const KEYGEN_RSA_PKCS1_MESSAGE_DIGEST_SHA384: KEYGEN_RSA_PKCS1_MESSAGE_DIGEST =
	KEYGEN_RSA_PKCS1_MESSAGE_DIGEST { inner: 5 };

/// SHA-512
pub const KEYGEN_RSA_PKCS1_MESSAGE_DIGEST_SHA512: KEYGEN_RSA_PKCS1_MESSAGE_DIGEST =
	KEYGEN_RSA_PKCS1_MESSAGE_DIGEST { inner: 6 };


/// Holds parameters for a sign operation with the [`KEYGEN_SIGN_MECHANISM_RSA_PSS`] mechanism.
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
#[repr(C)]
pub struct KEYGEN_SIGN_RSA_PSS_PARAMETERS {
	pub mask_generation_function: KEYGEN_SIGN_RSA_PSS_MASK_GENERATION_FUNCTION,
	pub salt_len: usize,
}

#[no_mangle]
pub extern "C" fn cbindgen_unused_KEYGEN_SIGN_RSA_PSS_PARAMETERS() -> KEYGEN_SIGN_RSA_PSS_PARAMETERS { unimplemented!(); }

/// Represents the mask generation function used for a sign operation with the [`KEYGEN_SIGN_MECHANISM_RSA_PSS`] mechanism.
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
#[repr(transparent)]
pub struct KEYGEN_SIGN_RSA_PSS_MASK_GENERATION_FUNCTION { inner: std::os::raw::c_uint }

/// SHA-1
pub const KEYGEN_SIGN_RSA_PSS_MASK_GENERATION_FUNCTION_SHA1: KEYGEN_SIGN_RSA_PSS_MASK_GENERATION_FUNCTION =
	KEYGEN_SIGN_RSA_PSS_MASK_GENERATION_FUNCTION { inner: 1 };

/// SHA-224
pub const KEYGEN_SIGN_RSA_PSS_MASK_GENERATION_FUNCTION_SHA224: KEYGEN_SIGN_RSA_PSS_MASK_GENERATION_FUNCTION =
	KEYGEN_SIGN_RSA_PSS_MASK_GENERATION_FUNCTION { inner: 2 };

/// SHA-256
pub const KEYGEN_SIGN_RSA_PSS_MASK_GENERATION_FUNCTION_SHA256: KEYGEN_SIGN_RSA_PSS_MASK_GENERATION_FUNCTION =
	KEYGEN_SIGN_RSA_PSS_MASK_GENERATION_FUNCTION { inner: 3 };

/// SHA-384
pub const KEYGEN_SIGN_RSA_PSS_MASK_GENERATION_FUNCTION_SHA384: KEYGEN_SIGN_RSA_PSS_MASK_GENERATION_FUNCTION =
	KEYGEN_SIGN_RSA_PSS_MASK_GENERATION_FUNCTION { inner: 4 };

/// SHA-512
pub const KEYGEN_SIGN_RSA_PSS_MASK_GENERATION_FUNCTION_SHA512: KEYGEN_SIGN_RSA_PSS_MASK_GENERATION_FUNCTION =
	KEYGEN_SIGN_RSA_PSS_MASK_GENERATION_FUNCTION { inner: 5 };
