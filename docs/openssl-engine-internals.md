This document talks about some basic crypto concepts, how the openssl API works, how openssl engines work, and how KS, libiothsm-keygen, and the two openssl engines used by it are structured.
